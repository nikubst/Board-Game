...
const translations = {
  en: {
    ...
    hero: {
      tagline: 'Premium art direction &bull; branding &bull; digital storytelling',
      title: 'NIKOO Art Studio',
  ...
  fa: {
    common: {
      ...
      contactUs: 'برای بحث درباره پروژه طراحی خود و چگونگی کمک ما برای تحقق بخشیدن به دیدگاه شما، امروز با ما تماس بگیرید.',
      studioName: 'نیکو',
    },
    hero: {
      tagline: 'هدتاپ هنری برتر &bull; برندسازی &bull; روایت دیجیتال',
      title: 'استودیو هنر نیکو',
